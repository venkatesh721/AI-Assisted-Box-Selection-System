...
`AI_USAGE.md` records the AI-tool usage, prompts, accepted or rejected output, mistakes, and verification performed for this repository. The submitter should review it before submission and ensure it accurately reflects their own work.
